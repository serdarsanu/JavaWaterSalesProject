...
public class NewCustomer extends javax.swing.JFrame {
    ...
    public void newCustomerfunc(){
        ...
        if(name.equals("")){
            ...
            try {
            DB db = new DB();
            int add = db.baglan().executeUpdate("INSERT INTO `customers` (`cid`, `cname`, `csurname`, `ctelephone`, `caddress`) "
                    + "VALUES (NULL, '"+name+"', '"+surname+"', '"+telephone+"', '"+address+"');");
            if(add > 0){
                ...
                JOptionPane.showMessageDialog(rootPane, "New Customer could not be added.");
            }
            } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(219, 469, 167, 52);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("New Customer");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(20, 0, 374, 42);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/glass.jpg"))); // NOI18N
